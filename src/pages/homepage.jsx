            ...
            {(progress === 100 && showMain) ? (
                <main className="relative mt-16 overflow-x-hidden">
                    ...
                    >
                        ...
                        <div className="select-none relative w-[70%] pl-8 h-full flex flex-col justify-center">
                            ...
                            >
                                ...
                                collection of professional make-up and stunning
                                wedding dresses, tailored to make your special
                            ...
                            <div className="mt-10 w-full flex items-center justify-between pr-16">
                                ...
                                >
                                    ...
                                    <p className="select-none text-[15px] mt-10">
                                        No need for printing costs, just create
                                        once and share
                                    </p>
                                ...
                                >
                                    ...
                                    <div className="w-full h-[1px] bg-black my-2"></div>
                                    <p className="select-none text-[15px] mt-10">
                                        Friendly service with a quick response
                                        to customer
                                    </p>
                                    <div className="active:scale-[0.97] duration-200 cursor-pointer text-[16px] px-4 mt-7 py-2 border w-max border-black flex items-center justify-center hover:bg-glow hover:animate-glow">
                                        <p>Check</p>
                                ...
                                >
                                    ...
                                    <div className="w-full h-[1px] bg-black my-2"></div>
                                    <p className="select-none text-[15px] mt-10">
                                        We offer a variety of modern themes that
                                        are perfect
                                    </p>
                                    <div className="active:scale-[0.97] duration-200 cursor-pointer text-[16px] px-4 mt-7 py-2 border w-max border-black flex items-center justify-center hover:bg-glow hover:animate-glow">
                                        <p>Check</p>
                        ...
                        <div className="relative w-[80%] ml-auto mt-[-30px] h-[200px] px-14 pt-8 bg-[#FFD476] border border-black text-[#030605]">
                            <div className="w-[80%]">
                                <p className="select-none text-[16px] leading-loose w-[70%] mb-4">
                                    ...
                                    digitally, invite them and share this happy
                                    news now
                                </p>
                            </div>
                    ...
                    >
                        ...
                        <div className="w-1/2 px-8 h-max">
                            ...
                            >
                                ...
                                Photography and <br /> Videography Services for
                                Every Event
                            </p>
                        </div>
                    </section>
                    ...
                    <section className="select-none relative w-screen h-max mt-[44px]">
                        ...
                        >
                            Timeless in the sophistication <br /> of our
                            equipment.
                        </h2>
                        <div>
                        ...
                        <div className="relative w-full h-[200px] flex justify-between items-center px-14 pb-14 pt-10 bg-[#FFD476] border border-black text-[#030605]">
                            ...
                            <div className="w-[80%] pr-2 ml-auto flex items-center">
                                <div className="w-[75%]">
                                    ...
                                    >
                                        We take pride in offering exceptional
                                        service for every couple, capturing
                                        every special moment of your wedding day
                                        with care and high quality
                                    </p>
                                </div>
                                <div
                                    data-aos="fade-dowm"
                        ...
                        <div className="relative text-center w-ful h-max">
                            <div className="w-full relative z-[99]">
                                <h2
                                    ...
                                    className="select-none font-normal text-[44px]"
                                >
                                    - The Ideal Place to Celebrate - <br /> Your
                                    True{" "}
                                ...
                                >
                                    Make your dream wedding come true at our
                                    elegant venue, with complete facilities.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="w-full flex items-center justify-between mt-[44px]">
                            ...
                            >
                                ...
                                <ul className="list-style-desc">
                                    ...
                                    <li className="mb-4">
                                        Highly trained staff attending
                                        throughout
                                    </li>
                                    <li className="mb-4">
                    ...
                    <section className="select-none relative w-screen min-h-[80vh] flex flex-col items-center justify-between overflow-hidden px-16 mt-[52px] mb-[44px]">
                        ...
                        <div className="w-full bg-[#FFD476] h-[480px] flex justify-center border border-black">
                            ...
                            <div className="relative w-1/2 flex flex-col justify-between">
                                ...
                                >
                                    Providing Luxury Souvenirs and the Best
                                    Gifts
                                </h2>
                        ...
                        <div className="w-full flex items-center">
                            ...
                            <div className="w-[70%] h-max pt-10 overflow-hidden">
                                <div className="w-full h-max px-16 border-y border-y-black ml-10 py-6">
                                    ...
                                    >
                                        Amaizing fast and reliable customer
                                        support! The team of willing to go mile
                    ...
                    <section className="select-none relative w-screen overflow-hidden min-h-[70vh] px-16 mt-[44px] flex flex-col z-[99]">
                        ...
                        <div className="mt-12">
                            ...
                            >
                                <div className="text-[16px] text-black leading-loose">
                                    <p>
                                        The process for wedding planning
                                        typically takes a few months, depending
                                        on the complexity of your wedding. The
                                        full coordination, from planning to
                                        execution, can take 1 to 3 months. For
                                        decorations and day-of coordination, our
                                        team is available to help manage
                                        everything on your big day, ensuring a
                                        smooth and memorable event.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                <div className="text-[16px] text-black leading-loose">
                                    <p>
                                        Yes, both our wedding organizing
                                        services and digital invitations are
                                        fully customizable. We work with you to
                                        tailor every detail to match your
                                        vision, from the event design to the
                                        invitations. Whether you have a specific
                                        theme in mind or want something unique,
                            ...
                            >
                                <div className="text-[16px] text-black leading-loose">
                                    <p>
                                        ...
                                        Whether it's a detail in your wedding
                                        plans or a correction to the digital
                                        invitation, we're happy to make
                                        revisions until everything is exactly
                                        how you envision it. We ensure your
                        ...
                        <div>
                            ...
                            >
                                <div className="text-[16px] text-black leading-loose">
                                    <p>
                                        Yes, we offer guarantees for our
                                        services. If there are any issues with
                                        our wedding organizing services or
                                        digital invitations, we will address
                                        them promptly. Our goal is to ensure
                                        your complete satisfaction with the
                                        services we provide, and we stand by the
                                        quality of our work.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            >
                                My wedding is still far away, can I register
                                now?{" "}
                            </div>
                            <div
                                className={`${
                            ...
                            >
                                <div className="text-[16px] text-black leading-loose">
                                    <p>
                                        Yes, you can register for our wedding
                                        organizing services and digital
                                        invitations now. We recommend booking
                                        early to ensure availability and to give
                                        you time to plan and make adjustments.
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="relative w-full h-[90%]">
                                    <div className="h-full">
                                        <h2 className="select-none text-[44px] mb-2">
                                            Your Perfect Wedding <br /> Starts
                                            Here{" "}
                                        </h2>
                                        <SparklesIcon className="absolute top-3 right-6 w-8 h-8" />
                                        <p className="select-none text-[16px] w-[80%] leading-loose text-black">
                                            Begin Your Love Journey With Us.
                                            Every great love story deserves a
                                            beautiful beginning. Let us help you
                                            plan a wedding that’s as special as
                                            your relationship
                                        </p>
                                        <hr className="my-4" />
                                        <ul className="ml-5">
