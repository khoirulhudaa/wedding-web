            ...
            <section className="select-none relative w-screen h-max lg:mt-[120px]">
                    ...
                    <div className="relative top-5 h-max">
                        <div className="w-max h-max lg:h-[140px] lg:ml-16 flex my-4 lg:border-l border-l-black">
                            <div className="h-max lg:h-[200px] flex flex-col justify-between">
                                <div className="relative lg:mb-0 mb-5 w-full lg:w-max h-max ml-6 lg:ml-8 border border-black p-3 flex items-center justify-center text-[16px] text-black">
                                    <p>Free hosting</p>
                                </div>
                                <div className="relative lg:mb-0 mb-5 w-full lg:w-max h-max ml-6 lg:ml-8 border border-black p-3 flex items-center justify-center text-[16px] text-black">
                                    <p>Free domain</p>
                            ...
                            <div className="w-1/2 h-max lg:flex items-baseline">
                                <div className="relative w-full lg:w-max h-max ml-12 lg:ml-8 border border-black p-3 flex items-center justify-center text-[16px] mb-5 text-black">
                ...
                <div className="relative w-full lg:w-[80%] ml-auto lg:mt-[-30px] h-max lg:h-[200px] px-6 lg:px-14 lg:pb-0 pb-8 pt-8 bg-[#FFD476] border-x-0 lg:border-x lg:border border-black text-[#030605]">
                    ...
                    <div className='flex items-center w-max'>
                        <Link to={"/invitation"}>
                            <div className="relative hover:bg-glow hover:text-black hover:animate-glow active:scale-[0.97] hover:brightness-[90%] text-center lg:w-max w-max flex no-underline px-3 h-max lg:px-6  py-3 lg:py-3.5 font-medium text-[16px] lg:text-[15px] bg-[#28887A] text-white cursor-pointer">
                                Order now{" "}
