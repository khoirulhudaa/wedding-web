        ...
        <main className="relative mt-16">
            ...
            <section className="relative w-full h-full overflow-hidden flex justify-center">
                ...
                <div className="relative w-full mt-0 h-max lg:h-[80vh] mb-4 lg:text-center mx-auto flex flex-col justify-center lg:items-center">
                    <div className="absolute top-0 lg:rounded-[10px] bg-white flex border-b border-b-black lg:text-[16px] text-[13px] text-black h-max w-full lg:w-screen lg:px-3 px-5 py-3 lg:py-2 mb-6 lg:mb-2 items-center lg:justify-center">
            ...
            <section className="relative flex items-center overflow-x-auto px-16 w-full border-t border-t-slate-500 h-max pb-14">
                ...
                <div className="w-1/2 px-8 h-max">
                    ...
                    <h2 className="font-normal text-[32px]">
                        Flawless Make-Up and Wedding Dresses for Your{" "}
                    ...
                    <div className="absolute top-6 right-14 text-[14px] px-4 py-2 border border-slate-500 flex items-center justify-center rounded-md hover:bg-glow hover:animate-glow">
                        <p>
            ...
            <section className="relative flex items-center overflow-x-auto px-16 w-full mt-[0px] h-max py-14">
                ...
                <div className="w-1/2 px-8 h-max">
                    ...
                    <h2 className="font-normal text-[32px]">
                        Photography & Videography Services for Your{" "}
            ...
            <section className="relative w-screen h-[100vh] mt-[40px]">
                <h2 className="text-[50px] font-normal w-[65%] ml-16">
                    Timeless in the sophistication of our equipment.
                </h2>
                <div>
                ...
                <div className="relative w-full h-[200px] flex justify-between items-center px-14 pb-14 pt-10 bg-[#FFD476] border border-black text-[#030605]">
                    <div className="absolute right-16 top-[-101%] w-max h-[200px] border-x border-t border-black flex items-center justify-center">
                      <div className="w-[120px] h-full">
                        <div className="w-full h-1/2 p-3 flex items-center justify-center overflow-hidden">
                          <img src={Gal1} alt="gallery" className="w-full h-full object-cover cursor-pointer duration-300 hover:grayscale-[100%]" />
                        </div>
                        <div className="w-full h-1/2 p-3 flex items-center justify-center overflow-hidden">
                          <img src={Gal2} alt="gallery" className="w-full h-full object-cover cursor-pointer duration-300 hover:grayscale-[100%]" />
                        </div>
                      </div>
                    ...
                    <div className="w-[80%] pr-2 ml-auto flex items-center">
                        <div className="w-[75%]">
                            <h2 className="text-[32px] w-max mb-4">
                                Servive Quality
                            </h2>
            ...
            <section className="relative px-16 w-screen h-[100vh] mt-[70px]">
                ...
                <div className="relative w-full h-[400px] border border-black overflow-hidden rounded-[20px]">
                    {/* Images */}
                    <div className="absolute top-6 left-6 z-[9999] h-full w-max">
                        <div className="bg-white rounded-[14px] mb-6 w-[50px] h-[50px]"></div>
                        <div className="bg-white rounded-[14px] mb-6 w-[50px] h-[50px]"></div>
                        <div className="bg-white rounded-[14px] mb-6 w-[50px] h-[50px]"></div>
                    </div>
                    ...
                    <div className="w-max flex items-center absolute right-6 top-3">
                        <div
                            ...
                            className="mr-5 z-[9999] text-center active:scale-[0.98] hover:brightness-90 lg:w-max w-max flex no-underline lg:ml-0 ml-5 mt-4 p-3 font-medium text-[14px] lg:text-[15px] bg-white text-black rounded-md lg:rounded-[10px] cursor-pointer"
                        >
                            <EyeIcon className="w-4 h-4 relative" />
                        </div>

                        <a
                            className="z-[9999] text-center lg:w-max w-max flex active:scale-[0.98] hover:brightness-90 no-underline lg:ml-0 ml-5 mt-4 px-4 lg:px-6 py-3 lg:py-2 font-medium text-[14px] lg:text-[15px] bg-white text-black rounded-md lg:rounded-[10px] cursor-pointer"
            ...
            <section className="relative border-r border-r-slate-500 w-screen overflow-hidden px-16 mt-[100px] min-h-[70vh]">
                ...
                <div className="w-full flex items-center">
                    ...
                    <div className="w-[70%] px-16 border-y border-y-slate-500 ml-10 py-6">
